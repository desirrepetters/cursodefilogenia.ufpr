...
<br><br>
Para este tutorial, iremos utilizar o software MEGA, seja na versão MEGA 7 ou MEGA X. Se você ainda não tem este software instalado, pode encontrar instruções aqui.
<br><br>
